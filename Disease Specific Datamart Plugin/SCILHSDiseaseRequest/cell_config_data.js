...
{
	files:[
		"SCILHSDiseaseRequest_ctrlr.js"
	],
	css:[ 
		"vwSCILHSDiseaseRequest.css"
	],
	config: {
		// additional configuration variables that are set by the system
		short_name: "SCILHS Disease Data Mart Request",
		name: "SCILHS Disease Data Mart Request",
		...
		plugin: {
			...
			html: {
				...
				mainDivId: 'SCILHSDiseaseRequest-mainDiv'
			}
		}
	}
}
